...
SERIAL_NO_TRUE = 0x5400  # it means that there is serial no. in packet
SERIAL_NO_FALSE = 0x5000  # it means that there is no serial no. in packet
DEFAULT_STATION_NO = 0xff
DEFAULT_PROCESSOR = 0x3ff

# device code to read certain area of memory
MEM = {
    'binary': {
        'D': 0xa8,
        'Y': 0x9d
