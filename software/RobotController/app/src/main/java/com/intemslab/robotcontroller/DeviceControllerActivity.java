...
public class DeviceControllerActivity extends AppCompatActivity {
    ...
    private final String mDeviceName = "HMSoft";
    private final String mDeviceAddress = "D4:36:39:BC:4B:4E";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speedCalculation = new SpeedCalculation();
    ...
    private void displayData(String data) {
        ...
        if (data != null) {
            String speeds = speedCalculation.updateSpeed(data);
            if (speeds != null) {
                mDataField.setText(speeds);
    ...
    private boolean set_text_updating(BluetoothGattCharacteristic characteristic){
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            String list_name = SampleGattAttributes.findName(uuid);
            if (list_name == null){
                continue;
            }
            currentServiceData.put(LIST_NAME, list_name);
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                list_name = SampleGattAttributes.findName(uuid);
                if (list_name == null){
                    continue;
                }
                currentCharaData.put(LIST_NAME, list_name);
                currentCharaData.put(LIST_UUID, uuid);
                set_text_updating(gattCharacteristic);
