...
public class MasterChooser extends AppCompatActivity {
  ...
  public static  String cmd_vel_topic = "/cmd_vel";
  public static  String odom_topic = "/odom";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    cmdText = (EditText) findViewById(R.id.cmd_vel);
    cmdText.setText(cmd_vel_topic);
    odomText = (EditText) findViewById(R.id.odom);
    odomText.setText(odom_topic);
  ...
  public void okButtonClicked(View unused) {
    ...
    cmd_vel_topic = cmdText.getText().toString();
    odom_topic = odomText.getText().toString();
  ...
  public Intent createNewMasterIntent(boolean newMaster, boolean isPrivate) {
    ...
    intent.putExtra("ROS_MASTER_NETWORK_INTERFACE", "");
    return intent;
  }
