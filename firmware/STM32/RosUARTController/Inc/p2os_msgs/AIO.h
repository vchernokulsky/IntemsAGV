...
namespace p2os_msgs
{
  ...
  class AIO : public ros::Msg
  {
    public:
      ...
      uint32_t voltages_length;
      typedef float _voltages_type;
      _voltages_type st_voltages;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->voltages_length >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->voltages_length >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->voltages_length >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->voltages_length >> (8 * 3)) & 0xFF;
      offset += sizeof(this->voltages_length);
      for( uint32_t i = 0; i < voltages_length; i++){
      union {
        float real;
        uint32_t base;
      } u_voltagesi;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->voltages_count);
      uint32_t voltages_lengthT = ((uint32_t) (*(inbuffer + offset))); 
      voltages_lengthT |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1); 
      voltages_lengthT |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2); 
      voltages_lengthT |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3); 
      offset += sizeof(this->voltages_length);
